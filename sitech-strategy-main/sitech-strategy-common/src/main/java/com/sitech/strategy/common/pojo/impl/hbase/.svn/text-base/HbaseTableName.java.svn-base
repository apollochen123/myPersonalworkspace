 ...
 */
public class HbaseTableName extends BaseClass implements IHbaseTableName,Serializable {
	
	/**
	 * 受理记录表
	 */
	public final String acceptRecord = new String("RM_ACCEPTRECORD_INFO");
	/**
	 * 批量push任务表
	 */
	public final String batchPushTask = new String("RM_BATCHPUSHTASK_INFO");
	/**
	 * 批量push任务统计表
	 */
	public final String batchPushTaskCount = new String("RM_BATCHPUSHTASK_COUNT_INFO");
	/**
	 * 批量push任务索引表
	 */
	public final String batchPushTaskIndex = new String("RM_BATCHPUSHTASK_INDEX_INFO");
	/**
	 * 批量push任务异常表
	 */
	public final String batchPushTaskExcep = new String("RM_BATCHPUSHTASKEXCEP_INFO");
	/**
	 * 批量push任务成功表
	 */
	public final String batchPushTaskSuccInfo = new String("RM_BATCHPUSHTASKSUCC_INFO");
	/**
	 * 渠道外呼接触表
	 */
	public final String channelCallContact = new String("RM_CHANNELCALLCONTACT_INFO");
	/**
	 * 渠道短信接触表
	 */
	public final String channelSMSContact = new String("RM_CHANNELSMSCONTACT_INFO");
	/**
	 * 渠道任务表
	 */
	public final String channelTask = new String("RM_CHANNELTASK_INFO");
	/**
	 * 点击记录表
	 */
	public final String clickRecord = new String("RM_CLICKRECORD_INFO");
	/**
	 * COC客户群明细表
	 */
	 ...
	 * 接触记录表
	 */
	public final String contactRecord = new String("RM_CONTACTRECORD_INFO");
	/**
	 * 客户群明细表
	 */
	 ...
	 * 灰名单表
	 */
	public final String grey = new String("RM_GREY_INFO");
	/**
	 * hbase测试表
	 */
	public final String hbaseTest = new String("RM_HBASETEST_INFO");
	/**
	 * 工号信息表
	 */
	public final String loginMsg = new String("RM_LOGINMSG_INFO");
	/**
	 * 营销案推荐统计表
	 */
	public final String marketCaseRecommendtotal = new String("RM_MARKETCASERECOMMENDTOTAL_INFO");
	/**
	 * 推送到达表
	 */
	public final String pushArrive = new String("RM_PUSHARRIVE_INFO");
	/**
	 * 回单记录表
	 */
	public final String receiptRecord = new String("RM_RECEIPTRECORD_INFO");
	/**
	 * 推荐受理记录表
	 */
	public final String recommendAcceptRecord = new String("RM_RECOMMENDACCEPTRECORD_INFO");
	/**
	 * 推荐关闭表
	 */
	public final String recommendClose = new String("RM_RECOMMENDCLOSE_INFO");
	/**
	 * 推荐记录表
	 */
	public final String recommendReord = new String("RM_RECOMMENDRECORD_INFO");
	/**
	 * 短信受理记录表
	 */
	public final String smsAcceptRecord = new String("RM_SMSACCEPTRECORD_INFO");
	/**
	 * 短信上行记录表
	 */
	public final String smsPull = new String("RM_SMSPULL_INFO");
	/**
	 * 用户信息表
	 */
	public final String user = new String("RM_USER_INFO");
	/**
	 * 用户受理营销案表
	 */
	public final String userAcceptMarketCase = new String("RM_USERACCEPTMARKETCASE_INFO");
	/**
	 * 用户标签表
	 */
	public final String userLabel = new String("RM_USERLABEL_INFO");
	/**
	 * 用户推荐控制表
	 */
	public final String userRecommendControl = new String("RM_USERRECOMMENDCONTROL_INFO");
	/**
	 * 用户转换关系表
	 */
	public final String userRel = new String("RM_USERREL_INFO");
	/**
	 * 待发送批量push任务表
	 */
	public final String waitSendBatchPushTask = new String("RM_WAITSENDBATCHPUSHTASK_INFO");	
	/**
	 * 操作日志信息表
	 */
	public final String operLogInfo = new String("RM_OPERLOG_INFO");
	
	/**
	 * 用户推荐营销案表
	 */
	public final String userRecommendMarketCase = new String("RM_USERRECOMMENDMARKETCASE_INFO");
...
/*	@Override
	...
	* update_version: update_date: update_author: update_note:
	...
	public String getCocCustomerGroup(String fromat) {
		cocCustomerGroup = "COC_CUSTOMER_GROUP_" + fromat;
	...
	* update_version: update_date: update_author: update_note:
	...
	public String getCustGroupDetail(String custGroupId) {
		custGroupDetail = "RM_CUSTGROUP_" + custGroupId + "_DETAIL_INFO";
	...
	*/
	...
	public String getCustGroupLabel(String custGroupId) {
		custGroupDetail = "RM_CUSTGROUP_" + custGroupId + "_LABEL_INFO";
		return custGroupDetail;
	}
