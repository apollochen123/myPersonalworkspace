 ...
 */
public class TopicByJLMob extends BaseClass implements ITopic,Serializable{
	
	/**
	 * 生产者消息主题
	 */
	public static final String PRODUCER_TOPIC_TEST= new String("");
	public static final String PRODUCER_TOPIC_TASKSYN= new String("");
	public static final String PRODUCER_TOPIC_MESSAGEPUSH= new String("");
	public static final String PRODUCER_TOPIC_GROUPMSGPUSH= new String("");
	public static final String PRODUCER_TOPIC_TRIGGERMSGEVENT = new String("TEventSyn");//事件触发消息
	...
	public static final String PRODUCER_TOPIC_RECOMMENDMSG_HIGH = new String("TSmsHigh");
	public static final String PRODUCER_TOPIC_RECOMMENDMSG_MIDDLE = new String("TSmsMiddle");
	public static final String PRODUCER_TOPIC_RECOMMENDMSG_LOW = new String("TSmsLow");
	
	/**
	 * 消费者消费主题
	 */
	public static final String CONSUMER_TOPIC_TEST = new String("");//测试
	public static final String CONSUMER_TOPIC_PRODORDEREVENT = new String("");//产品订购
	public static final String CONSUMER_TOPIC_ACCEPTCOUPLEBACK = new String("");//受理记录反馈
	public static final String CONSUMER_TOPIC_COUPLEBACK = new String("TCoupleBackDest");//实时营销接收反馈消息
	public static final String CONSUMER_TOPIC_GROUPMSGEVENT = new String("");//集团业务
	public static final String CONSUMER_TOPIC_TRIGGERMSGEVENT = new String("TEventSynDest");//事件触发消息
	...
	* @description: 
	* update_version: update_date: update_author: update_note:
	* 2017-2-28 luogj 增加入参,根据短信等级获取对应的主题名称
	 */
	@Override
	public String getProducerTopicRecommendMsg(String shortMsgLevel) {
		if( Const.SHORT_MSG_LEVEL_HIGH.equals(shortMsgLevel) ){
			return PRODUCER_TOPIC_RECOMMENDMSG_HIGH;
		}else if( Const.SHORT_MSG_LEVEL_MIDDLE.equals(shortMsgLevel) ){
			return PRODUCER_TOPIC_RECOMMENDMSG_MIDDLE;
		}else if( Const.SHORT_MSG_LEVEL_LOW.equals(shortMsgLevel) ){
			return PRODUCER_TOPIC_RECOMMENDMSG_LOW;
		}
		return null;
	}
